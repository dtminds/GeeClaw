...
export function Startup() {
  ...
  const renderCenterPanel = () => {
      ...
      return (
        <div className="mx-auto flex w-full max-w-[46rem] flex-col items-center gap-7 text-center">
          <motion.div
            ...
            className="relative flex h-40 w-40 items-center justify-center rounded-[2rem] border border-black/5 bg-white/58 shadow-[0_24px_60px_-32px_rgba(41,52,79,0.28)] backdrop-blur-sm"
          >
            <div className="absolute inset-3 rounded-[1.5rem] bg-gradient-to-br from-white/95 via-white/45 to-sky-100/60" />
            <motion.div
            ...
            <div className="absolute -right-3 top-6 flex h-11 w-11 items-center justify-center rounded-full bg-white/90 shadow-[0_10px_30px_-18px_rgba(30,54,93,0.55)]">
          ...
          <div className="w-full space-y-5">
            <div>
              <h1 className="text-balance text-[clamp(1.95rem,4vw,2.85rem)] font-semibold tracking-[-0.04em] text-slate-950">
                {loadingCopy.title}
              </h1>
            </div>

            <div className="mx-auto w-full max-w-[46rem]">
              <div className="h-4 overflow-hidden rounded-full bg-black/6 shadow-[inset_0_1px_0_rgba(255,255,255,0.7)]">
                <motion.div
                  className="h-full rounded-full bg-[linear-gradient(90deg,rgba(16,16,18,0.98),rgba(26,33,45,0.92)_58%,rgba(70,87,116,0.62))]"
                  initial={{ width: '8%' }}
      ...
      return (
        <div className="mx-auto flex w-full max-w-[34rem] flex-col items-center gap-7 text-center">
          <motion.div
            ...
            animate={{ opacity: 1, scale: 1, y: 0 }}
            transition={{ duration: 0.55, ease: [0.22, 1, 0.36, 1] }}
            className="relative flex h-36 w-36 items-center justify-center rounded-[2rem] border border-black/5 bg-white/58 shadow-[0_24px_60px_-32px_rgba(41,52,79,0.24)] backdrop-blur-sm"
          >
            <div className="absolute inset-3 rounded-[1.5rem] bg-gradient-to-br from-white/95 via-white/55 to-sky-100/52" />
            <img src={geeclawIcon} alt="GeeClaw" className="h-24 w-24 drop-shadow-[0_16px_18px_rgba(255,125,90,0.16)]" />
          </motion.div>
          <motion.div
          ...
          >
            <h2 className="text-balance text-[clamp(1.8rem,3.7vw,2.65rem)] font-bold tracking-[-0.04em] text-slate-950">
              {t('startup.needsLogin.title')}
            </h2>
          </motion.div>
          <Button
            className="h-12 min-w-44 rounded-full bg-slate-950 px-6 text-sm font-medium text-white shadow-[0_20px_35px_-24px_rgba(15,23,42,0.9)] hover:bg-slate-800"
    ...
    if (phase === 'needs_provider') {
      return (
        ...
        >
          <div className="rounded-[2rem] border border-white/65 bg-white/68 p-7 shadow-[0_24px_64px_-40px_rgba(24,42,71,0.28)] backdrop-blur-lg">
            <div className="flex items-start gap-4">
              <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[linear-gradient(180deg,rgba(247,255,252,0.96),rgba(227,245,237,0.9))] shadow-[0_10px_24px_-18px_rgba(31,104,74,0.34)]">
              ...
              <div className="min-w-0 flex-1">
                ...
                <h2 className="mt-2 text-[clamp(1.8rem,3.4vw,2.8rem)] font-semibold tracking-[-0.045em] text-slate-950">
          ...
          <div className="rounded-[2rem] border border-white/70 bg-white/80 p-7 shadow-[0_26px_72px_-44px_rgba(24,42,71,0.28)] backdrop-blur-xl">
            <ProviderContent
              providers={[]}
    ...
    return (
      <motion.div
        ...
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.45, ease: [0.22, 1, 0.36, 1] }}
        className="mx-auto w-full max-w-[40rem] rounded-[2rem] border border-red-200/60 bg-white/74 p-8 shadow-[0_28px_80px_-44px_rgba(69,27,27,0.2)] backdrop-blur-xl"
      >
        <div className="flex items-start gap-4">
          <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-[linear-gradient(180deg,rgba(255,248,248,0.98),rgba(255,236,236,0.92))] shadow-[0_12px_26px_-20px_rgba(173,51,51,0.38)]">
          ...
          <div className="min-w-0 flex-1">
            ...
            <Button
              className="mt-6 h-12 rounded-full bg-slate-950 px-6 text-sm font-medium text-white hover:bg-slate-800"
              onClick={() => void retry()}
            >
  ...
  return (
    <div className="startup-shell flex h-screen flex-col overflow-hidden text-slate-950">
      <TitleBar />
