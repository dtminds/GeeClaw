...
const WEB_SEARCH_PROVIDER_DESCRIPTORS: WebSearchProviderDescriptor[] = [
  ...
  },
  {
    ...
    docsUrl: 'https://docs.openclaw.ai/tools/exa-search',
    autoDetectOrder: 8,
    requiresCredential: true,
  ...
  },
  {
    ...
    docsUrl: 'https://docs.openclaw.ai/tools/gemini-search',
    autoDetectOrder: 3,
    requiresCredential: true,
  ...
  },
  {
    ...
    docsUrl: 'https://docs.openclaw.ai/tools/grok-search',
    autoDetectOrder: 5,
    requiresCredential: true,
  ...
  },
  {
    ...
    docsUrl: 'https://docs.openclaw.ai/tools/kimi-search',
    autoDetectOrder: 4,
    requiresCredential: true,
  ...
  },
  {
    ...
    docsUrl: 'https://docs.openclaw.ai/tools/ollama-search',
    autoDetectOrder: 11,
    requiresCredential: false,
    credentialPath: '',
  ...
  },
  {
    ...
    docsUrl: 'https://docs.openclaw.ai/tools/perplexity-search',
    autoDetectOrder: 6,
    requiresCredential: true,
