 ...
 */
export const PORTS = {
  /** GeeClaw GUI development server port */
  GEECLAW_DEV: 5173,
  
  /** GeeClaw GUI production port (for reference) */
  GEECLAW_GUI: 23333,
...
export function getPort(key: keyof typeof PORTS): number {
  const envKey = `GEECLAW_PORT_${key}`;
...
export const APP_PATHS = {
  ...
  OPENCLAW_CONFIG: '~/.openclaw-geeclaw',
  
  /** GeeClaw configuration directory */
  GEECLAW_CONFIG: '~/.geeclaw',
