...
async function setupManagedPresetFixture(options?: {
  ...
  vi.doMock('@electron/utils/paths', () => ({
    ...
    getAgentMarketplaceCatalogPath: () => join(homeDir, 'site', 'res', 'agent-marketplace-catalog-v2.json'),
    getAgentMarketplaceCatalogUrl: () => 'https://www.geeclaw.cn/res/agent-marketplace-catalog-v2.json',
