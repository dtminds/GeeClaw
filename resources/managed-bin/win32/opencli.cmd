...
set OPENCLI_EMBEDDED_IN=GeeClaw
set "NODE_EXE=%~dp0..\bin\node.exe"
set "OPENCLI_ENTRY=%~dp0..\opencli\dist\main.js"

if not exist "%OPENCLI_ENTRY%" (
    echo Error: bundled opencli entry not found at %OPENCLI_ENTRY%
    set "_EXIT=1"
    goto finish
)
