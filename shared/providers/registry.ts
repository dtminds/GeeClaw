...
function createGeeClawCompatibleProvider(
  ...
  return {
    ...
    defaultModelId: options.defaultModelId ?? 'mimo-v2.5',
    defaultModels: options.defaultModels ?? [createDefaultProviderModel('mimo-v2.5')],
...
export const PROVIDER_DEFINITIONS: ProviderDefinition[] = [
  ...
  },
  {
    ...
    defaultModels: [createDefaultProviderModel('gpt-5.5'), createDefaultProviderModel('gpt-5.4')],
    modelCatalogMode: 'builtin-only',
    isOAuth: true,
    supportsApiKey: true,
    showModelId: true,
